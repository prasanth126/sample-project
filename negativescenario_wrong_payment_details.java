...
public class negativescenario_wrong_payment_details {
	WebDriver driver;
    @BeforeMethod
    ...
    driver.findElement(By.xpath("//input[@id='upi']")).sendKeys("sss@paytm");
    String paymenterror = screen.find("C\\Users\\prasanth\\Desktop\\screen shots\\images\\paymenterror.PNG").text();
